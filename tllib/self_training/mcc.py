...
class sc_net(nn.Module):
    def __init__(self, input_size, num_of_class,features_dim=64):
        super(sc_net, self).__init__()
        self.input_size = input_size
        self.features_dim = features_dim
        self.encoder = nn.Sequential(nn.Linear(self.input_size, self.features_dim))
        self.classifier = nn.Sequential(nn.Linear(self.features_dim, num_of_class))
    ...
    def forward(self, data):
        ...
        return cell_prediction, embedding
